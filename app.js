...
async function recreateDB(){
 ...
 price:"Fifteen USD"});
  ...
  let instance2 = new
  Roasted({Itemname:"roasted sandwich grill", Quantity:60,
  price:"sixteen USD"});
   instance1.save( function(err,doc) {
   if(err) return console.error(err);
   ...
   let instance3 = new
   Roasted({Itemname:"roasted chicken sandwich", Quantity:190,
   price:"Twenty USD"});
    instance1.save( function(err,doc) {
    if(err) return console.error(err);
    ...
    let instance4 = new
    Roasted({Itemname:"roasted grill chicken sandwich", Quantity:86,
